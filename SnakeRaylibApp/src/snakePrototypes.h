...
// Initiate the game settings. Create a window, set the size of that window, the target fps and do seed for random value generation.
void gameSetup(void);
...
// Iterates a linked list and draw each node unto the screen. This will write the snake onto the game.
